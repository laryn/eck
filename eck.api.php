 ...
 */
function hook_eck_entity_type_insert(EckEntityType $entity_type) {
 ...
 */
function hook_eck_entity_type_update(EckEntityType $entity_type) {
 ...
 */
function hook_eck_entity_type_delete(EckEntityType $entity_type) {
